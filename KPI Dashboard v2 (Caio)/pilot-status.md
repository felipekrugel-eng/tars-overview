...
PRICE_OBSERVED_SIGNAL: $5.21 (modal $5.00, 56 adopters)
PRICE_CHANGE_DETECTED: False
PRICE_FINDING: flat: merchants arriving after the change pay $5.21 on average against $5.17 before, within normal tier-mix wobble
INTENDED_TIER: S_SALESHISTORY_1_USD_V003
INTENDED_TIER_SUBS_GLOBAL: 1
INTENDED_TIER_PILOT_SUBS_SINCE_LAUNCH: 1

## New payers (the primary metric)
BASELINE_PILOT_PER_DAY: 3.633
SIGNAL_PILOT_PER_DAY: 2.7
BASELINE_CONTROL_PER_DAY: 55.633
SIGNAL_CONTROL_PER_DAY: 55.05
DID: 0.751
PILOT_SIGNAL_COUNT: 54
EXPECTED: 71.9
NULL95: [56, 89]
P_VALUE: 0.0169
READABLE: True
...
REVENUE_SIGNAL_PER_DAY: 41.35
COUNTERFACTUAL_REVENUE_PER_DAY: 63.58
DID_REVENUE: 0.65
