...
PRICE_OBSERVED_SIGNAL: $5.24 (modal $5.00, 67 adopters)
PRICE_CHANGE_DETECTED: False
PRICE_FINDING: flat: merchants arriving after the change pay $5.24 on average against $5.17 before, within normal tier-mix wobble
INTENDED_TIER: S_SALESHISTORY_1_USD_V003
INTENDED_TIER_SUBS_GLOBAL: 3
INTENDED_TIER_PILOT_SUBS_SINCE_LAUNCH: 3

## New payers (the primary metric)
BASELINE_PILOT_PER_DAY: 3.633
SIGNAL_PILOT_PER_DAY: 2.75
BASELINE_CONTROL_PER_DAY: 55.628
SIGNAL_CONTROL_PER_DAY: 54.375
DID: 0.774
PILOT_SIGNAL_COUNT: 66
EXPECTED: 85.2
NULL95: [68, 104]
P_VALUE: 0.0183
READABLE: True
...
REVENUE_SIGNAL_PER_DAY: 39.0
COUNTERFACTUAL_REVENUE_PER_DAY: 62.8
DID_REVENUE: 0.621
