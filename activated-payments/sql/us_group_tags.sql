...
-- it is pulling and defaults to US. us_bot_accounts stays hard-scoped to US;
-- global_bot_accounts covers every other market (see us_bases.sql).
...
LEFT JOIN active_ids a ON a.LOYVERSE_ID = u.LOYVERSE_ID;   -- [bot-filter]
