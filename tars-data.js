const TARS_DATA = {
  ...
  initiatives: [
    {
      ...
      actions: [
        ...
        { id: "A-260417-03", text: "Validate metrics pipeline (Stripe Sigma + Snowflake dashboards)", owner: "Simon", ownerColor: "#1D8FE1", ownerInitial: "S", due: "25 Apr", status: "overdue", initiative: "payments" }
      ]
    },
    {
      id: "pricing",
  ...
  generalBacklog: [
    ...
    { id: "A-260612-01", text: "Circulate daily KPI dashboard starting Monday", owner: "Felipe", ownerColor: "#7B61FF", ownerInitial: "F", due: "15 Jun", status: "in-progress", initiative: "general" },
    { id: "A-260612-02", text: "Pressure-test finding that 78% of web traffic arrives via Spanish-language pages", owner: "Simon", ownerColor: "#1D8FE1", ownerInitial: "S", due: "19 Jun", status: "in-progress", initiative: "general" },
    { id: "A-260612-03", text: "Share website prototype with team", owner: "Alex", ownerColor: "#2DC46B", ownerInitial: "A", due: "19 Jun", status: "in-progress", initiative: "general" },
    { id: "A-260612-04", text: "Bring in-app messaging series to next Friday's dedicated discussion", owner: "Alex", ownerColor: "#2DC46B", ownerInitial: "A", due: "19 Jun", status: "in-progress", initiative: "general" }
  ],
