...
var TARS_DATA = {
  ...
  generalActions: [
    ...
    { id: "A-260130-04", text: "Send daily calendar invitations (2\u20133 PM UK time) for continuous strategy meetings", owner: "Alex", ownerColor: "#2DC46B", ownerInitial: "A", due: "2 Feb", status: "done" },
    { id: "A-260206-02", text: "Share ranked list of top 10 countries with Caio; Felipe to save it in Strategic Sessions folder", owner: "Simon", ownerColor: "#1D8FE1", ownerInitial: "S", due: "13 Feb", status: "done" },
    ...
    { id: "A-260206-04", text: "Make a proposal for next steps and send information in WhatsApp group", owner: "Caio", ownerColor: "#E1A21D", ownerInitial: "C", due: "9 Feb", status: "done" },
    { id: "A-260206-05", text: "Calculate proper NPV starting Wednesday with Alex", owner: "Caio", ownerColor: "#E1A21D", ownerInitial: "C", due: "11 Feb", status: "done" },
    { id: "A-260213-01", text: "Send one or two governance processes to Caio for internalization to agree on governors", owner: "Simon", ownerColor: "#1D8FE1", ownerInitial: "S", due: "20 Feb", status: "done" },
    { id: "A-260213-05", text: "Book meeting to discuss org structure and reconciliation", owner: "Simon", ownerColor: "#1D8FE1", ownerInitial: "S", due: "20 Feb", status: "done" },
    ...
    { id: "A-260306-05", text: "Write capital allocation section in strategy document", owner: "Caio", ownerColor: "#E1A21D", ownerInitial: "C", due: "9 Mar", status: "overdue" },
    { id: "A-260306-06", text: "Add comments to strategy document via Google Docs", owner: "Simon", ownerColor: "#1D8FE1", ownerInitial: "S", due: "9 Mar", status: "done" },
    { id: "A-260306-07", text: "Review Simon\u2019s comments, add own pages, share updated version of strategy document", owner: "Caio", ownerColor: "#E1A21D", ownerInitial: "C", due: "10 Mar", status: "done" },
    { id: "A-260306-08", text: "Share Excel revenue numbers with Caio to update the presentation", owner: "Alex", ownerColor: "#2DC46B", ownerInitial: "A", due: "9 Mar", status: "overdue" },
    { id: "A-260306-09", text: "Update strategy presentation with correct revenue numbers and future focus", owner: "Caio", ownerColor: "#E1A21D", ownerInitial: "C", due: "13 Mar", status: "done" },
    { id: "A-260306-10", text: "Investigate why there is less pressure from Thiago on numbers this year vs last year; save meeting script", owner: "Felipe", ownerColor: "#7B61FF", ownerInitial: "F", due: "13 Mar", status: "overdue" },
    { id: "A-260306-11", text: "Write letter to board members and Thiago once strategy document is finalised", owner: "Caio", ownerColor: "#E1A21D", ownerInitial: "C", due: "20 Mar", status: "overdue" },
    { id: "A-260316-08", text: "Coordinate Snowflake data migration and Claude AI integration meeting (with Felipe, Alex, Dimitri)", owner: "Simon", ownerColor: "#1D8FE1", ownerInitial: "S", due: "23 Mar", status: "overdue" },
    { id: "A-260316-09", text: "Continue developing AI-powered notes and task automation agent (Claude AI + Google Drive)", owner: "Felipe", ownerColor: "#7B61FF", ownerInitial: "F", due: "23 Mar", status: "overdue" },
