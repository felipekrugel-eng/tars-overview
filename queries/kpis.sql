...
-- GTV from LOYVERSE_RECEIPTS (TOTAL_MONEY is in smallest currency unit — divide by POWER(10, minor_units))
...
gtv_data AS (
  SELECT COALESCE(SUM(TOTAL_MONEY / POWER(10, fx.minor_units) * fx.rate), 0) AS total_gtv_eur
